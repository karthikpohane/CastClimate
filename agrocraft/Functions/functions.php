                ...
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:542px'>
                    ...
                    <div class='card-body pb-0'>
                        <div class='row'>
                            ...
                            <div class='col-12 col-xl-6 col-lg-6 col-md-6 col-sm-12' style='padding-left:0;'>
                                <div class='input-group mb-1'>
                                    ...
                                    <input type='number' class='form-control' aria-label='Default' style='margin-top:0%;width:22%;padding:0%;' aria-describedby='inputGroup-sizing-default'>
                                    <a href='../BuyerPortal2/bhome.php?add_cart=$product_id' class='btn btn-warning border-secondary mr-1  ' style='color:black ;font-weight:50px;margin-top:25px;width:100%;'>Add to cart<img src='carticons.png' height='20px'></a>
