...
<div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <div id="drag-drop-area" style="border: 2px dotted grey; padding: 10px;">
                                            <p>Drag and drop files here or click to choose file:</p>
                                            </div>

                                            <!-- Hidden file input -->
                                            <input id="permanent_address" type="file" style="display:none;" name="product_image">

                                            <script>
                                            var dragDropArea = document.getElementById("drag-drop-area");
                                            var fileInput = document.getElementById("file-input");

                                            // Add event listeners to the drag and drop area
                                            dragDropArea.addEventListener("dragover", function(event) {
                                            event.preventDefault();
                                            dragDropArea.style.backgroundColor = "lightgray";
                                            });
                                            ...
                                            console.log(fileInput.files); // Log the selected files to the console
                                            });
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder">Product Price : (Per kg)</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number3" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder">Product :</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number4" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder">Available to delivery :</label>
                                        <div class="col-md-6">
