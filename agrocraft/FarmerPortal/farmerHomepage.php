...
<link href="https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.css" rel="stylesheet">
 ...
 <body>
		...
		<!-- <div class="logo">
			<i class="ri-leaf-fill"></i><a id="alogo" href="/Main_P/home/home.php">Cast-Climate</a></div> -->
                ...
                <header>
		<div class="logo">
			<i class="ri-leaf-fill"></i><a id="alogo" href="#">Cast-Climate</a></div>
	</header>
                <!-- <a class="float-left" href="../index.html" style="backgound-color : green">
                     Cast-Climate
                </a> -->
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          <div class="carousel-item active">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/vegetables.jpg" alt="First slide">
                          </div>
           ...
           <div class="features container">
                <h1 style="font-weight: bold;color:black; text-align:center">Our feature</h1>
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">CallCenter System </h4>
                               <br>
