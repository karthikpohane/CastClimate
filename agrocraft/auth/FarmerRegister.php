...
<body>
 <header>
		<div class="logo">
			<i class="ri-leaf-fill"></i><a id="alogo" href="./FarmerLogin.php">Cast-Climate</a></div>
		</center></a>
	</header>
<main class="my-form">
		<div class="cotainer">
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerRegister.php" method="post">
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="text" id="full_name" class="form-control border border-dark" name="username" placeholder="Enter Your Name" required>
									</div>
								</div>
