    ...
    <form action="checkout.php" method="post">
        ...
        <div class="container mt-5">
            ...
            <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b style="font-size: 35px;">Grand total = Rs. <?php echo $_SESSION['grandtotal']; ?> </b></h4>
                </div>
        </div>
<br>
        <div class="container mt-5">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div class="float-none float-sm-none float-md-none float-lg-left float-xl-right goback ">
        <a href="cartpage.php"><button type="button" class="btn btn-lg  border border-dark  " style="font-size:22px;color:black;background-color:#FFD700;margin-left:-355%;">
